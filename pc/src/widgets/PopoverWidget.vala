...
public class EKM4Android.Widgets.PopoverWidget : Gtk.Stack {
    public signal void request_close ();
    /*
    private EKM4Android.Widgets.MainView main_view;
    private EKM4Android.Widgets.DiscoveryView discovery_view;
    */

    public PopoverWidget (EKM4Android.Services.ObjectManager object_manager, bool is_in_session) {
